  ...
  useEffect(() => {
    ...
    Promise.all([listStudents({ isActive: true }), listAcademicYears()])
      .then(([studentData, yearData]) => {
        setStudents(studentData); setYears(yearData);
