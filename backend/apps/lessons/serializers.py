...
class LessonSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            ...
            "term_number", "weekday", "start_time", "end_time", "room", "started_at", "ended_at",
    ...
    def validate(self, attrs):
        ...
        lesson_date = attrs.get("lesson_date", getattr(self.instance, "lesson_date", None))
        if not entry or not teacher or not lesson_date:
            return attrs
        ...
        if lesson_date < term.start_date or lesson_date > term.end_date:
