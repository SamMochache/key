...
class TermAdmin(admin.ModelAdmin):
    list_display = ("term_number", "academic_year", "start_date", "end_date", "is_current", "is_active")
...
class ProgrammeAdmin(admin.ModelAdmin):
    list_display = ("name", "curriculum", "display_order", "is_active")
    search_fields = ("name",)
...
class CambridgeStageAdmin(admin.ModelAdmin):
    list_display = ("name", "programme", "stage_number", "display_order", "is_active")
    search_fields = ("name",)
    list_filter = ("programme", "is_active")
    ordering = ("programme", "display_order")


@admin.register(MontessoriLevel)
class MontessoriLevelAdmin(admin.ModelAdmin):
    list_display = ("name", "code", "minimum_age", "maximum_age", "display_order", "is_active")
...
class SubjectAdmin(admin.ModelAdmin):
    list_display = ("name", "code", "curriculum", "is_core", "is_active")
    search_fields = ("name", "code")
    list_filter = ("curriculum", "is_core", "is_active")
    ordering = ("display_order", "name")


@admin.register(StageSubject)
class StageSubjectAdmin(admin.ModelAdmin):
    list_display = ("cambridge_stage", "subject", "weekly_lessons", "is_core", "display_order")
    list_filter = ("cambridge_stage", "is_core")
